...
{
private:
    template <typename T1>  friend void mergeSort(SingleList<T1>& rhv);
    template <typename T1>  friend void merge(typename SingleList<T1>::Node* left,
                                                                        typename SingleList<T1>::Node* right,
                                                                        typename SingleList<T1>::Node* righ);
    template <typename T1>  friend void myAdvance(typename SingleList<T1>::Node*& rhv, const size_t count);
