...
private:
    ...
    friend void quickSortSingleList(SingleList<T1>& rhv);
    template <typename T1>
    friend void quickSortSingleList(typename SingleList<T1>::Node* first, typename SingleList<T1>::Node* last);
    template <typename T1>
    friend value_type partitionSingleList(typename SingleList<T1>::Node* first, typename SingleList<T1>::Node* last);
    template <typename T1>
    friend void myAdvance(typename SingleList<T1>::Node* rhv, const size_t count);
    template <typename T1>
    friend size_t distanse(typename SingleList<T1>::Node* first, typename SingleList<T1>::Node* last);
