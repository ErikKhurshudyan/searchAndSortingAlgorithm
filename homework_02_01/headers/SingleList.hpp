...
private:
    ...
    friend bool linearSearch(const SingleList<T1>& rhv, const T1& k);

    template <typename T1>
    friend bool linearSearchHelper(typename SingleList<T1>::Node* first, typename SingleList<T1>::Node* end, const T1& k);
