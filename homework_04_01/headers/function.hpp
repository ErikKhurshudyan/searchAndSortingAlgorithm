...
template <typename T>
bool binarySearchHelper(T* first, T* last, const T& k);

template <typename T>
bool binarySearch(const SingleList<T>& rhv, const T& k);

template <typename T>
bool binarySearchHelper1(typename SingleList<T>::Node* first,typename SingleList<T>::Node* last, const T& k);

template <typename T>
bool binarySearch(const List<T>& rhv, const T& k);

template <typename T>
bool binarySearchHelper2(typename List<T>::Node* first,typename List<T>::Node* last, const T& k);
