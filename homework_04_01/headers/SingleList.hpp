...
private:
    ...
    friend bool binarySearch(const SingleList<T1>& rhv, const T1& k);
    template <typename T1>
    friend bool binarySearchHelper1(typename SingleList<T1>::Node* first, typename SingleList<T1>::Node* last, const T1& key);
    template <typename T1>
    friend void myAdvance(typename SingleList<T1>::Node* rhv, const size_t count);
    template <typename T1>
    friend size_t myDistance(typename SingleList<T1>::Node* first, typename SingleList<T1>::Node* last);
    template <typename T1> 
