...
private:
    ...
    friend bool binarySearch(const List<T1>& rhv, const T1& k);
    template <typename T1>
    friend bool binarySearchHelper2(typename List<T1>::Node* first,typename List<T1>::Node* last, const T1& k);
    template <typename T1>
