...
private:
    ...
    friend void quickSortList(List<T1>& rhv);
    template <typename T1>
    friend void quickSortList(typename List<T1>::Node* first, typename List<T1>::Node* last);
    template <typename T1>
    friend typename List<T1>::Node* partitionList(typename List<T1>::Node* first, typename List<T1>::Node* last);
