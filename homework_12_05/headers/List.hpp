...
private:
    ...
    friend void shellSortList(List<T1>& rhv);
    template <typename T1>
    friend typename List<T1>::Node* myAdvance(typename List<T1>::Node* rhv, const size_t count);
    template <typename T1>
    friend size_t distanse(typename List<T1>::Node* first, typename List<T1>::Node* last);
