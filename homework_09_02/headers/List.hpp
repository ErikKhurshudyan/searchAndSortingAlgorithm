...
public:
    ...
    friend void mergeSort(List<T1>& rhv);
    template <typename T1>
    friend void mergeSort1(typename List<T1>::Node* first, typename List<T1>::Node* last);
    template <typename T1>
    friend void merge1(typename List<T1>::Node* first, typename List<T1>::Node* middle, typename List<T1>::Node* last);
    template <typename T1>
    friend void myAdvance(typename List<T1>::Node* rhv, const size_t count);
    template <typename T1>
    friend size_t myDistance(typename List<T1>::Node* first, typename List<T1>::Node* last);
    template <typename T1>
    friend typename List<T1>::Node* myAdvance1(typename List<T1>::Node* rhv, const size_t count);
    template <typename T1>
    friend size_t myDistance1(typename List<T1>::Node* first, typename List<T1>::Node* last);
